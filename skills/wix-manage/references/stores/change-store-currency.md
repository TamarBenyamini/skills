...
Use the [Update Site Regional Properties (Currency, Time Zone, Language)](../site-properties/update-site-regional-properties.md) recipe to set the requested payment currency and read it back. Confirm the change with the user before updating it.
